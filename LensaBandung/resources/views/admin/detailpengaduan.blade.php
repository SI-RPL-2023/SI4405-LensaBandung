...
<body>
    ...
    : activate to sort column ascending"
                      ...
                      document.getElementById('proses').submit();">
                                            ...
                                            <form id="proses" action="{{ url('admin/proses', $item['id']) }}"
      ...
      document.getElementById('delete-form').submit();"><button
                                        ...
                                        @if ($item->status == 'diproses')
                                            <a class="btn btn-primary"
                                                href="{{ url('accept-pengaduan', $item['id']) }}"
                                                onclick="event.preventDefault();
                      document.getElementById('accept').submit();">
                                                {{ __('Accept') }}
                                            </a>
                                            <a class="btn btn-danger"
                                                href="{{ url('denied-pengaduan', $item['id']) }}"
                                                onclick="event.preventDefault();
                      document.getElementById('denied').submit();">
                                                {{ __('Denied') }}
                                            </a>
                                            <form id="accept"
                                                action="{{ url('admin/accept-pengaduan', $item['id']) }}"
                                                method="POST" class="d-none">
                                                @csrf
                                            </form>
                                            <form id="denied"
                                                action="{{ url('admin/denied-pengaduan', $item['id']) }}"
                                                method="POST" class="d-none">
                                                @csrf
                                            </form>
                                        @endif
