    ...
    <div class="container-fluid container-xl d-flex align-items-center justify-content-between">
      ...
      <nav id="navbar" class="navbar">
        <ul>
          ...
          <li><a href="/profil-kota">Profil Kota</a></li>
          <li><a href="/pengaduan">Pengaduan</a></li>
          <li><a href="/kontak-penting">Kontak Penting</a></li>
      ...
      <div class="row">
        <div class="col-xl-4">
          ...
          <blockquote data-aos="fade-up" data-aos-delay="100">
            <p>
              Platform pengaduan online berbasis website yang didedikasikan untuk membantu masyarakat Kota Bandung. Kami hadir untuk Anda sebagai solusi pengaduan yang mudah, cepat, dan aman
            </p>
          </blockquote>
          <div class="d-flex" data-aos="fade-up" data-aos-delay="200">
            <a href="/pengaduan" class="btn-get-started">+Buat Pengaduan</a>
    ...
    <section id="why-us" class="why-us">
      <div class="container" data-aos="fade-up">
        ...
        <div class="row g-0" data-aos="fade-up" data-aos-delay="200">
          ...
          <div class="col-xl-5 img-bg" style="background-image: url('/TemplateNOVA/assets/img/why-us-bg.jpg')"></div>
        ...
        <div class="row">
          ...
          <div class="col-lg-5 position-relative" data-aos="fade-up" data-aos-delay="200">
            <div class="phone-wrap">
              <img src="/TemplateNOVA/assets/img/iphone.png" alt="Image" class="img-fluid">
            </div>
          </div>
        </div>
      ...
      <div class="container" data-aos="fade-up">
        ...
        <div class="row gy-5">
          ...
          <div class="col-xl-3 col-md-6" data-aos="fade-up" data-aos-delay="100">
            <div class="post-box">
              <div class="post-img"><img src="/TemplateNOVA/assets/img/blog/blog-1.jpg" class="img-fluid" alt=""></div>
              <div class="meta">
          ...
          <div class="col-xl-3 col-md-6" data-aos="fade-up" data-aos-delay="200">
            <div class="post-box">
              <div class="post-img"><img src="/TemplateNOVA/assets/img/blog/blog-2.jpg" class="img-fluid" alt=""></div>
              <div class="meta">
          ...
          <div class="col-xl-3 col-md-6" data-aos="fade-up" data-aos-delay="300">
            <div class="post-box">
              <div class="post-img"><img src="/TemplateNOVA/assets/img/blog/blog-3.jpg" class="img-fluid" alt=""></div>
              <div class="meta">
          ...
          <div class="col-xl-3 col-md-6" data-aos="fade-up" data-aos-delay="400">
            <div class="post-box">
              <div class="post-img"><img src="/TemplateNOVA/assets/img/blog/blog-4.jpg" class="img-fluid" alt=""></div>
              <div class="meta">
